...
extension UIAlertController {
    ...
    static func showAlert(inViewController viewController: UIViewController, title: String? = nil, message: String? = nil, confimAction: @escaping (_ alertAction: UIAlertAction) -> Void) {
